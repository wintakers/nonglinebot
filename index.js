...
function handleMessageEvent(event) {
   ...
   let eventText = event.message.text.toLowerCase();
    ...
    if (eventText === 'ขอที่อยู่') {
        ...
        msg = {
            'type': 'text',
            text: ' งบประมาณเงินรายได้\n-	อยู่ระหว่างการจัดสรรงบประมาณ ประกาศผลช่วงประมาณ ต.ค. – พ.ย. 2562 สอบถาม คุณศิรินภา โทร 2425, งบประมาณเงินแผ่นดิน (บูรณา)-	อยู่ระหว่างการพิจารณาของสำนักงบประมาณ ประกาศผลช่วงประมาณ ต.ค. – พ.ย. 2562 สอบถาม คุณศิรินภา โทร 2425, งบประมาณภายนอกอื่น ๆ-	ติดต่อคุณวรารัตน์ โทร 2425, วช.-	https://www.nrms.go.th/'
