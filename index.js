...
function handleMessageEvent(event) {
   ...
   let eventText = event.message.text.toLowerCase();
    ...
    if (eventText === 'ขอที่อยู่') {
        ...
        msg = {
            'type': 'text',
            text: '1. ข้อเสนอโครงการ 2. แผนการใช้จ่ายเงิน (สวพ.2) 3. อนุมัติโครงการ (สวพ. 1 เฉพาะงบบูรณาการ)ดาวน์โหลดเอกสาร http://www.ird.rmutr.ac.th/doc/ติดต่อคุณวรารักษ์ โทร 2424'
            
        }
    }else if (eventText === 'เบิกเงินงวดที่ 2') {
        msg = {
            'type': 'text',
            text: '1. แบบ สวพ.4 2. แบบ สวพ.5 3. หลักฐานการใช้จ่ายเงิน (ตัวจริง) จำนวน ....... ฉบับ 4. แบบ สวพ.6 รายงานความก้าวหน้าโครงการวิจัย จำนวน 5 หน้า - (รายงานความก้าวหน้าโครงการวิจัย) แบบ สวพ. 6.1 - (รายงานความก้าวหน้าแผนวิจัยของชุดโครงการวิจัย) แบบ สวพ. 6.2 5. การส่งรายงานความก้าวหน้าผ่านระบบ NRMS (กรณีจัดทำข้อเสนอโครงการวิจัยผ่านระบบ NRMS) ดาวน์โหลดเอกสาร http://www.ird.rmutr.ac.th/doc/ ติดต่อคุณวรารักษ์ โทร 2424 '
            
        }
    }else if (eventText === 'เบิกเงินงวดที่ 3') {
        msg = {
            'type': 'text',
            text: '1. แบบ สวพ. 4 2. แบบ สวพ. 5 3. แบบ สวพ. 7 4. หลักฐานการใช้จ่ายเงิน (ตัวจริง) จำนวน ........ ฉบับ 5. การส่งรายงานฉบับสมบูรณ์ผ่านระบบ NRMS (กรณีจัดทำข้อเสนอโครงการวิจัยผ่านระบบ NRMS) 6. รายงานวิจัยฉบับสมบูรณ์ จำนวน 3 เล่ม แบ่งเป็น 6.1 ต้นสังกัด จำนวน 1 เล่ม 6.2 ส่งสถาบันวิจัยและพัฒนา จำนวน 2 เล่ม 7. บทสรุปการดำเนินงานและผลงานวิจัย (แบบสวพ. 13) 8. แผ่นซีดีบันทึกข้อมูลรายงานวิจัยฉบับสมบูรณ์  (ข้อ 6) และบทสรุปการดำเนินงาน และผลงานวิจัย (ข้อ 7) โดยบันทึกเป็นไฟล์นามสกุล  (docx. และ pdf.) จำนวน 5 แผ่น แบ่งเป็น  8.1 ติดท้ายเล่มรายงานส่งต้นสังกัด 1 แผ่น  8.2 ติดท้ายเล่มรายงานส่งสถาบันวิจัยฯ 2 แผ่น  8.3 ใส่ซองแผ่นซีดี  จำนวน 2 แผ่น  9. หลักฐานของผลผลิต/ผลลัพธ์ของงานวิจัย (ภาคผนวกท้ายเล่มรายงานวิจัย) (ถ้ามี)  10. หลักฐานการส่งมอบครุภัณฑ์ให้กับหน่วยงานต้นสังกัดจำนวน  ........ ฉบับ(ถ้ามี) ดาวน์โหลดเอกสาร http://www.ird.rmutr.ac.th/doc/ ติดต่อคุณวรารักษ์ โทร 2424'
