...
function handleMessageEvent(event) {
   ...
   let eventText = event.message.text.toLowerCase();
    ...
    if (eventText === 'ขอที่อยู่') {
        ...
        msg = {
            'type': 'text',
            text: '1. แบบ สวพ.4\n2. แบบ สวพ.5\n3. หลักฐานการใช้จ่ายเงิน (ตัวจริง) จำนวน ....... ฉบับ\n4. แบบ สวพ.6 รายงานความก้าวหน้าโครงการวิจัย จำนวน 5 หน้า\n- (รายงานความก้าวหน้าโครงการวิจัย) แบบ สวพ. 6.1\n- (รายงานความก้าวหน้าแผนวิจัยของชุดโครงการวิจัย) แบบ สวพ. 6.2        5. การส่งรายงานความก้าวหน้าผ่านระบบ NRMS (กรณีจัดทำข้อเสนอโครงการวิจัยผ่านระบบ NRMS) ดาวน์โหลดเอกสาร http://www.ird.rmutr.ac.th/doc/ ติดต่อคุณวรารักษ์ โทร 2424 '
